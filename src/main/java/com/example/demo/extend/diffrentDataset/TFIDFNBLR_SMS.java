...
public class TFIDFNBLR_SMS {
    ...
    public static final String MODEL_PATH_NB = "E:\\FinalProject\\models\\DatasetModel\\SMS\\TFIDFNBLR\\NB";
    public static final String MODEL_PATH_LR = "E:\\FinalProject\\models\\DatasetModel\\SMS\\TFIDFNBLR\\LR";
...
//                "预测错误：" + wrong + "封邮件！\r\n" +
        ...
        evaluationDataset.setAlgorithm("TFIDFNBLR");
