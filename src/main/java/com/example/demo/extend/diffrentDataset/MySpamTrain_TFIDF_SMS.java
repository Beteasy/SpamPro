...
@Service
public class MySpamTrain_TFIDF_SMS {
...
//    public static final String DATA_PRE_PATH = "E:\\FinalProject\\datasets\\trec06c";
    public static final String MODEL_PATH = "E:\\FinalProject\\models\\DatasetModel\\TFIDF";
    public static final String TOP2N_PATH  = "E:\\FinalProject\\models\\DatasetModel\\top2n.txt";
    //the number of spam used for training
    public static final Integer SPAM_NUM_TRAIN = 10;
    //the number of ham used for training
    public static final Integer HAM_NUM_TRAIN = 10;
    //the number of spam used for predicting
    public static final Integer SPAM_NUM_PREDICT = 10;
    //the number of ham used for predicting
    public static final Integer HAM_NUM_PREDICT = 10;
    //特征数量
    ...
    public void trainAndPre() {
        ...
        List<String> spamTopN = getTopN(keySpamWords, FEATURE_NUM);
        List<String> hamTopN = getTopN(keyHamWords, FEATURE_NUM);
        ...
        ArrayList<LabeledPoint> spamLabledPointList = getTrainData(keySpamWords, allKeyWord, 1.0, FEATURE_NUM);
        ArrayList<LabeledPoint> hamLabledPointList = getTrainData(keyHamWords, allKeyWord, 0.0, FEATURE_NUM);
        ...
        try {
            ...
            while ((tmp = bufferedReader.readLine()) != null) {
                ...
                if (hamNum_pre>=3000 && spamNum_pre>=3000){
                    break;
                }
            }
            bufferedReader.close();
        ...
        double accuracy = Double.valueOf(decimalFormat.format((double)(spamLabeledPointList_pre.size() - wrong) / spamLabeledPointList_pre.size()));
