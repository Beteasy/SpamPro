...
@Service
public class MySpamTrain_TFIDF_TREC {
    ...
    public static final String MODEL_PATH = "E:\\FinalProject\\models\\DatasetModel\\TREC";
    public static final String TOP2N_PATH = "E:\\FinalProject\\datasets\\trec06c\\spam_java_trec.txt";
