...
public class TFIDFSVMSGD_SMS {
    ...
    public static final String MODEL_PATH = "E:\\FinalProject\\models\\DatasetModel\\SMS\\TFIDFSVMSGD";
...
//        RDD<LabeledPoint> preRDD = javaSparkContext.parallelize(spamLabeledPointList_pre).rdd();
        ...
        evaluationDataset.setAlgorithm("TFIDFSVMSGD");
        ...
        boolean b2 = evaluationDatasetService.save(evaluationDataset);
