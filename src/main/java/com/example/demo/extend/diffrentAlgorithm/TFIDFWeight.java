...
public class TFIDFWeight {
    ...
    public static final String MODEL_PATH = "E:\\FinalProject\\models\\AlgorithmModels\\TFIDFWeight";
    public static final String TOP2N_PATH = "E:\\FinalProject\\models\\AlgorithmModels\\TFIDFWeight\\spam_java.txt";
...
//        }
        ...
        //对元数据列表进行特征匹配生成训练数据
        System.out.println("**********************对元数据列表进行特征匹配生成训练数据——做加权********************");
        ArrayList<LabeledPoint> spamLabeledPointList = getTrainData(keySpamWords, spamTFIDF,allKeyWord, 1.0, FEATURE_NUM);
        ArrayList<LabeledPoint> hamLabeledPointList = getTrainData(keyHamWords, hamTFIDF,allKeyWord, 0.0, FEATURE_NUM);
        ...
        ArrayList<LabeledPoint> spamLabeledPointList_pre = getPreData(spamWords, allKeyWord, 1.0, FEATURE_NUM);
        ArrayList<LabeledPoint> hamLabeledPointList_pre = getPreData(hamWords, allKeyWord, 0.0, FEATURE_NUM);
...
//                "预测错误率为：" + decimalFormat.format((double)wrong / labeledPoints.size()) + "！"
        ...
        evaluationAlgTable.setId("TFIDFNBWeight");
     ...
     * @return
     */
    public static ArrayList<LabeledPoint> getPreData(ArrayList<ArrayList<String>> wordList, ArrayList<String> keyWords, double type, Integer featureNum) {
