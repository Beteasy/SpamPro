...
import static com.example.demo.extend.diffrentAlgorithm.TFIDFNBLRService.MODEL_PATH_LR;
...
public class TFIDFSVMSGD {
    ...
    public static final String MODEL_PATH = "E:\\FinalProject\\models\\AlgorithmModels\\TFIDFSVMSGD";;
...
//                "预测错误率为：" + decimalFormat.format((double)wrong / labeledPoints.size()) + "！"
        ...
        evaluationAlgTable.setId("TFIDFSVMSGD");
